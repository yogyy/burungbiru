...
import { PageLayout } from "./layouts/root-layout";
      ...
      <div className="px-4 pb-3 pt-3">
        <div className="relative flex w-full flex-wrap justify-between">
          <div className="-mt-[15%] mb-3 w-1/4 min-w-[48px]">
            <div className="relative flex aspect-square max-h-[140px] w-full max-w-[140px] items-center justify-center overflow-hidden rounded-full bg-background object-cover p-1">
...
UserNotFound.getLayout = function getLayout(page: ReactElement) {
