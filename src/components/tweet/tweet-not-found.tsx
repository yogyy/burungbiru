    ...
    <>
      ...
      <PageLayout>
        <div className="flex h-full min-h-screen w-full max-w-[600px] flex-col border-x border-border">
          ...
          <div className={cn("relative w-full max-w-full border-border px-3 py-10 outline-none")}>
            <div className="mt-10 flex h-auto flex-col items-center justify-center px-3 py-5">
              ...
              <Button disabled className="h-auto py-1.5 text-base font-bold leading-5">
                Search
              </Button>
            </div>
          </div>
